    ...
    <>
      <section className="bg-white bg-[url('/images/shape-15.png')] bg-cover bg-center bg-no-repeat ">
        <div className="max-w-screen-xl mx-auto py-28  ">
          <h1 className="text-4xl sm:text-6xl font-bold text-center mb-24 mt-24 capitalize text-primary">
            Contact Us
          </h1>
          ...
          <div className="flex  space-x-8">
            ...
            >
              <div className="flex items-center justify-center w-[70px] h-[70px] bg-white-one rounded-full hover:bg-secondary transition-colors duration-300 mb-6">
                <Image
        ...
        <div className="container mx-auto mt-20 mb-28 px-4 sm:px-6">
