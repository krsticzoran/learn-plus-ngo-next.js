    ...
    <>
      <section className=" pb-20 mt-5">
        <div className=" max-w-screen-xl mx-auto ">
          <div className="flex ">
            <div className=" mt-36 w-[640px] ml-auto pt-20">
              ...
              <div className="flex pt-20">
                ...
                >
                  ...
                  <p className="text-primary text-lg pt-1">
                    someemail@gmail.com
                  </p>
                </Link>
            ...
            <div className="w-[50%]  pl-[50px]">
              <div className="bg-primary pt-[210px]  rounded-[20px] relative h-[620px]  flex  items-center pl-[345px] ">
                <Image
      ...
      <section
        className="  bg-white bg-[url('/images/shape-15.png')] bg-cover bg-center bg-no-repeat  pt-28 pb-28"
        id="pdf"
      >
        <div className="max-w-screen-xl mx-auto  ">
          <div className="mb-16">
