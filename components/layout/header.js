...
export default function Navbar() {
  ...
  return (
    <header className="absolute z-50 w-full bg-transparent text-primary">
      <Container
        as="nav"
        className={`mt-8 flex items-center justify-between font-poppins text-lg font-medium uppercase leading-7 xl:font-spartan xl:font-semibold xl:capitalize ${pathname === "/contact" ? "lg:mt-10" : "lg:mt-[60px]"}`}
      >
        {/*Logo*/}
        <Link href="/">
          <Image
